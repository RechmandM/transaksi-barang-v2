            ...
            <form action="<?= $url_post ?>" method="post">
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <input readonly type="text" class="form-control" id="kodesupp" name="kodesupp" value="<?= $id_supp ?>" placeholder="Kode Supplier" required>
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" id="nm_supp" name="nm_supp" value="<?= $nm_supp ?>" placeholder="Nama Supplier" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" id="telp" name="telp" value="<?= $telp ?>" placeholder="Telp" required>
                        <div class="invalid-feedback">
