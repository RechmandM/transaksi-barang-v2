<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-3">
    ...
    <div>
        ...
        <form action="<?= base_url() . $url_post ?>" method="POST" enctype="multipart/formdata">
            <div class="">
                <input class="form-control w-50 mb-2" name="cari" type="text" value="<?= $cari ?>" placeholder="">
                <input class="btn btn-outline-primary w-25" type="submit" value="Cari">

                <input onclick="Paramfunc.print()" class="btn btn-primary w-25" type="button" value="Print">
            </div>
        </form>
    </div>
...
<script>
    var ParamFunc = {
        print: function() {
            var cari = $('#cari').val();
            if (cari) {
                window.top.location.href = 'Datalaporan/print/' + cari;
            } else {
