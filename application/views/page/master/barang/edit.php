            ...
            <form action="<?= $url_post ?>" method="post" enctype="multipart/form-data">
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <input readonly type="text" class="form-control" id="kodebarang" name="kodebarang" placeholder="Kode Barang" value="<?= $kodebarang ?>" required>
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" id="nm_barang" name="nm_barang" placeholder="Nama Barang" value="<?= $nm_barang ?>" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="number" class="form-control" id="stock_mn" name="stock_mn" placeholder="Stock" value="<?= $stock_mn ?>" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-sm-6">
                        ...
                        <img id="displaying" src="<?= $base ?>/assets/img/upload/<?= ($file_gambar) ? $file_gambar : 'default.png' ?>" class="img-thumbnail" border="0" height="100" width="130" style="max-width: 130px;" alt="img">

                        <input type="hidden" name="<?= $file_gambar ?>" class=" form-control" id="file_gambar" name="file_gambar">

                        <input onchange="ubahGambar(this)" type="file" class="form-control" id="fileupload" name="fileupload" required>
                        <div class="invalid-feedback">
                            Valid stock is required.
                        </div>
                    </div>
